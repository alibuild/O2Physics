...
float VarManager::GetTPCPostCalibMap(float pin, float eta, int particle_type, TString period)
{
  ...
  if (period.Contains("LHC22m_pass1_subset")) {
    ...
    float El_mean_curve_pin = (pin < 0.3) ? 1.74338 : ((pin > 0.3) & (pin < 5)) ? 1 / (0.694318 + -5.66879 * pin) + 2.73696 + 0.000483342 * pin
                                                    : (pin > 5)                 ? 2.70321
                                                                                : 0.0;
    float Pi_mean_curve_pin = (pin < 0.3) ? 1.95561 : ((pin > 0.3) & (pin < 3)) ? -0.0606029 / pin + 2.18796 + -0.101135 * pin
                                                    : (pin > 3)                 ? 1.86435
                                                                                : 0.0;
    float Pr_mean_curve_pin = (pin < 0.4) ? 1.94664 : ((pin > 0.4) & (pin < 5)) ? 1 / (-0.495484 + -1.03622 * pin) + 3.0513 + -0.0143036 * pin
                                                    : (pin > 5)                 ? 2.80362
                                                                                : 0.0;
    ...
    float pin_map = (particle_type == 0) ? El_mean_curve_pin : (particle_type == 1) ? Pi_mean_curve_pin
                                                             : (particle_type == 2) ? Pr_mean_curve_pin
                                                                                    : 0.0;
    float eta_map = (particle_type == 0) ? El_mean_curve_eta : (particle_type == 1) ? Pi_mean_curve_eta
                                                             : (particle_type == 2) ? Pr_mean_curve_eta
                                                                                    : 0.0;
    float map = pin_map + eta_map;
    return map;
  } else if (period.Contains("LHC22f_pass1")) {
    float El_mean_curve_pin = (pin < 0.3) ? 0.24335236 : ((pin > 0.3) & (pin < 3.5)) ? 1 / (0.0113621 - 2.44516 * pin) + 1.63907 - 0.0367754 * pin
                                                       : (pin > 3.5)                 ? 1.3933518
                                                                                     : 0.0;
    float Pi_mean_curve_pin = (pin < 0.3) ? -0.30059726 : ((pin > 0.3) & (pin < 3.5)) ? 1 / (-4.51007e+06 - 5.52635e+06 * pin) - 0.349193 + 0.171139 * pin - 0.0305089 * pin * pin
                                                        : (pin > 3.5)                 ? -0.12394057
                                                                                      : 0.0;
    float Pr_mean_curve_pin = (pin < 0.3) ? 0.1 : ((pin > 0.3) & (pin < 3.5)) ? 1 / (0.482973 - 3.55557 * pin) + 1.38574 - 0.627066 * pin + 0.103612 * pin * pin
                                                : (pin > 3.5)                 ? 0.37665460
                                                                              : 0.0;
