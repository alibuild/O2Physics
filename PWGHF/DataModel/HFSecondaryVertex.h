...
DECLARE_SOA_TABLE(HfPvRefitTrack, "AOD", "HFPVREFITTRACK", //!
                  hf_pvrefit_track::PvRefitX, hf_pvrefit_track::PvRefitY,
                  hf_pvrefit_track::PvRefitZ, hf_pvrefit_track::PvRefitSigmaX2,
...
DECLARE_SOA_INDEX_COLUMN_FULL(Index1, index1, int, Tracks,
                              "_1"); //! Index to second prong
DECLARE_SOA_INDEX_COLUMN_FULL(Index2, index2, int, Tracks,
                              "_2");         //! Index to third prong
...
DECLARE_SOA_TABLE(Hf2Prongs, "AOD",
                  "HF2PRONG", //! Table for HF 2 prong candidates
                  o2::soa::Index<>, hf_track_index::Index0Id,
                  hf_track_index::Index1Id, hf_track_index::HFflag);
using Hf2Prong = Hf2Prongs::iterator;

DECLARE_SOA_TABLE(HfCascades, "AOD",
                  "HFCASCADE", //! Table for HF candidates with a V0
                  o2::soa::Index<>, hf_track_index::Index0Id,
                  hf_track_index::V0Id);
using HfCascade = HfCascades::iterator;

DECLARE_SOA_TABLE(Hf3Prongs, "AOD",
                  "HF3PRONG", //! Table for HF 3 prong candidates
                  o2::soa::Index<>, hf_track_index::Index0Id,
                  hf_track_index::Index1Id, hf_track_index::Index2Id,
...
DECLARE_SOA_TABLE(HfCutStatusProng2, "AOD", "HFCUTSTATUSP2", //!
                  hf_track_index::D0ToKPiFlag, hf_track_index::JpsiToEEFlag,
...
DECLARE_SOA_DYNAMIC_COLUMN(RSecondaryVertex, rSecondaryVertex, //!
                           [](float xVtxS, float yVtxS) -> float {
                             return RecoDecay::sqrtSumOfSquares(xVtxS, yVtxS);
                           });
DECLARE_SOA_COLUMN(Chi2PCA, chi2PCA,
                   float); //! sum of (non-weighted) distances of the secondary
                           //! vertex to its prongs
// prong properties
...
DECLARE_SOA_DYNAMIC_COLUMN(Pt2Prong0, pt2Prong0, //!
                           [](float px, float py) -> float {
                             return RecoDecay::pt2(px, py);
                           });
DECLARE_SOA_DYNAMIC_COLUMN(PVectorProng0, pVectorProng0, //!
                           [](float px, float py, float pz) -> array<float, 3> {
...
DECLARE_SOA_DYNAMIC_COLUMN(ImpactParameterNormalised0,
                           impactParameterNormalised0, //!
                           [](float dca, float err) -> float {
                             return dca / err;
                           });
...
DECLARE_SOA_DYNAMIC_COLUMN(ImpactParameterNormalised1,
...
DECLARE_SOA_DYNAMIC_COLUMN(ImpactParameterNormalised2,
...
DECLARE_SOA_DYNAMIC_COLUMN(P, p, //!
                           [](float px, float py, float pz) -> float {
                             return RecoDecay::p(px, py, pz);
                           });
DECLARE_SOA_DYNAMIC_COLUMN(P2, p2, //!
                           [](float px, float py, float pz) -> float {
                             return RecoDecay::p2(px, py, pz);
                           });
...
DECLARE_SOA_DYNAMIC_COLUMN(Eta, eta, //!
                           [](float px, float py, float pz) -> float {
                             return RecoDecay::eta(array{px, py, pz});
                           });
DECLARE_SOA_DYNAMIC_COLUMN(Phi, phi, //!
                           [](float px, float py) -> float {
                             return RecoDecay::phi(px, py);
                           });
DECLARE_SOA_DYNAMIC_COLUMN(Y, y, //!
                           [](float px, float py, float pz, double m) -> float {
                             return RecoDecay::y(array{px, py, pz}, m);
                           });
DECLARE_SOA_DYNAMIC_COLUMN(E, e, //!
                           [](float px, float py, float pz, double m) -> float {
                             return RecoDecay::e(px, py, pz, m);
                           });
DECLARE_SOA_DYNAMIC_COLUMN(E2, e2, //!
                           [](float px, float py, float pz, double m) -> float {
                             return RecoDecay::e2(px, py, pz, m);
                           });
...
DECLARE_SOA_DYNAMIC_COLUMN(DecayLengthXYNormalised, decayLengthXYNormalised, //!
                           [](float xVtxP, float yVtxP, float xVtxS,
                              float yVtxS, float err) -> float {
                             return RecoDecay::distanceXY(array{xVtxP, yVtxP},
                                                          array{xVtxS, yVtxS}) /
                                    err;
                           });
...
DECLARE_SOA_DYNAMIC_COLUMN(CPA, cpa,                               //!
                           [](float xVtxP, float yVtxP, float zVtxP,
                             ...
                             return RecoDecay::cpa(array{xVtxP, yVtxP, zVtxP},
                                                   array{xVtxS, yVtxS, zVtxS},
                                                   array{px, py, pz});
                           });
DECLARE_SOA_DYNAMIC_COLUMN(CPAXY, cpaXY, //!
                           [](float xVtxP, float yVtxP, float xVtxS,
                              float yVtxS, float px, float py) -> float {
                             return RecoDecay::cpaXY(array{xVtxP, yVtxP},
                                                     array{xVtxS, yVtxS},
                                                     array{px, py});
                           });
DECLARE_SOA_DYNAMIC_COLUMN(
...
DECLARE_SOA_DYNAMIC_COLUMN(ImpactParameterProngSqSum,
                           ...
                           [](float impParProng0, float impParProng1) -> float {
                             return RecoDecay::sumOfSquares(impParProng0,
                                                            impParProng1);
                           });
DECLARE_SOA_DYNAMIC_COLUMN(
...
// dynamic columns
DECLARE_SOA_EXTENDED_TABLE_USER(HfCandProng2Ext, HfCandProng2Base,
                                "HFCANDP2EXT", //!
                                hf_cand_prong2::Px, hf_cand_prong2::Py,
                                hf_cand_prong2::Pz);
...
DECLARE_SOA_TABLE(HfCandProng2MCRec, "AOD", "HFCANDP2MCREC", //!
                  hf_cand_prong2::FlagMCMatchRec, hf_cand_prong2::OriginMCRec);

// table with results of generator level MC matching
DECLARE_SOA_TABLE(HfCandProng2MCGen, "AOD", "HFCANDP2MCGEN", //!
                  hf_cand_prong2::FlagMCMatchGen, hf_cand_prong2::OriginMCGen);
...
//                  v0data::PxNeg, v0data::PyNeg, v0data::PzNeg>,
//                  v0data::MAntiLambda<v0data::PxPos, v0data::PyPos,
//                  v0data::PzPos, v0data::PxNeg, v0data::PyNeg, v0data::PzNeg>,
//                  v0data::MK0Short<v0data::PxPos, v0data::PyPos,
//                  v0data::PzPos, v0data::PxNeg, v0data::PyNeg,
//                  v0data::PzNeg>);

// extended table with expression columns that can be used as arguments of
// dynamic columns
DECLARE_SOA_EXTENDED_TABLE_USER(HfCandCascExt, HfCandCascBase,
                                "HFCANDCASCEXT", //!
                                hf_cand_casc::Px, hf_cand_casc::Py,
                                hf_cand_casc::Pz);
...
// extended table with expression columns that can be used as arguments of
// dynamic columns
DECLARE_SOA_EXTENDED_TABLE_USER(HfCandBPlusExt, HfCandBPlusBase,
                                "HFCANDBPLUSEXT", hf_cand_prong2::Px,
                                hf_cand_prong2::Py, hf_cand_prong2::Pz);
...
DECLARE_SOA_EXTENDED_TABLE_USER(HfCandProng3Ext, HfCandProng3Base,
                                "HFCANDP3EXT", //!
                                hf_cand_prong3::Px, hf_cand_prong3::Py,
                                hf_cand_prong3::Pz);
...
auto DRX(const T& candidate, int numPi)
{
  ...
  if (numPi <= 1) {
    etaPi = RecoDecay::eta(array{candidate.pxProng1(), candidate.pyProng1(),
                                 candidate.pzProng1()});
    phiPi = RecoDecay::phi(candidate.pxProng1(), candidate.pyProng1());
  } else {
    etaPi = RecoDecay::eta(array{candidate.pxProng2(), candidate.pyProng2(),
                                 candidate.pzProng2()});
...
DECLARE_SOA_TABLE(HfCandXMCRec, "AOD", "HFCANDXMCREC", //!
                  hf_cand_x::FlagMCMatchRec, hf_cand_x::OriginMCRec,
                  hf_cand_x::FlagMCDecayChanRec);

// table with results of generator level MC matching
DECLARE_SOA_TABLE(HfCandXMCGen, "AOD", "HFCANDXMCGEN", //!
                  hf_cand_x::FlagMCMatchGen, hf_cand_x::OriginMCGen,
...
DECLARE_SOA_TABLE(HfCandXiccMCRec, "AOD", "HFCANDXICCMCREC", //!
                  hf_cand_xicc::FlagMCMatchRec, hf_cand_xicc::OriginMCRec,
...
DECLARE_SOA_TABLE(HfCandChicMCRec, "AOD", "HFCANDCHICMCREC", //!
                  hf_cand_chic::FlagMCMatchRec, hf_cand_chic::OriginMCRec,
                  hf_cand_chic::FlagMCDecayChanRec);

// table with results of generator level MC matching
DECLARE_SOA_TABLE(HfCandChicMCGen, "AOD", "HFCANDCHICMCGEN", //!
                  hf_cand_chic::FlagMCMatchGen, hf_cand_chic::OriginMCGen,
...
DECLARE_SOA_TABLE(HfCandLbMCRec, "AOD", "HFCANDLBMCREC", //!
                  hf_cand_lb::FlagMCMatchRec, hf_cand_lb::OriginMCRec,
                  hf_cand_lb::DebugMCRec);

// table with results of generator level MC matching
DECLARE_SOA_TABLE(HfCandLbMCGen, "AOD", "HFCANDLBMCGEN", //!
                  hf_cand_lb::FlagMCMatchGen, hf_cand_lb::OriginMCGen);
} // namespace o2::aod
