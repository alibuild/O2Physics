...
struct FITtest {
  ...
  void processHadronic(CC const& collision, BCs const& bct0s, TCs const& tracks, aod::FT0s const& ft0s, aod::FV0As const& fv0as, aod::FDDs const& fdds, aod::Zdcs& zdcs, aod::V0s const& v0s)
  {
    ...
    if (totAmplitudeA > 0) {
      registry.get<TH1>(HIST("collHadronic/FT0/FT0AampHadronic"))->Fill(nPVcont);
    }
    if (totAmplitudeC > 0) {
      registry.get<TH1>(HIST("collHadronic/FT0/FT0CampHadronic"))->Fill(nPVcont);
    }
    if ((totAmplitudeA > 0) || (totAmplitudeC > 0)) {
      registry.get<TH2>(HIST("collHadronic/FT0/FT0ACCorrHadronic"))->Fill(totAmplitudeA, totAmplitudeC);
    }
    ...
    if (totalAmplitudefv0 > 0) {
      registry.get<TH1>(HIST("collHadronic/FV0/FV0AmpHadronic"))->Fill(nPVcont);
    }
    ...
    if (totAmpFddA > 0) {
      registry.get<TH1>(HIST("collHadronic/FDD/FDDAampHadronic"))->Fill(nPVcont);
    }
    if (totAmpFddC > 0) {
      registry.get<TH1>(HIST("collHadronic/FDD/FDDCampHadronic"))->Fill(nPVcont);
    }
    if ((totAmpFddA > 0) || (totAmpFddC > 0)) {
      registry.get<TH2>(HIST("collHadronic/FDD/FDDACCorrHadronic"))->Fill(totAmpFddA, totAmpFddC);
    }

    // Correlation FV0 vs FT0
    if ((totalAmplitudefv0 > 0) || (totAmplitudeA > 0)) {
      registry.get<TH2>(HIST("collHadronic/FV0T0ACorrHadronic"))->Fill(totAmplitudeA, totalAmplitudefv0);
    }
    if ((totalAmplitudefv0 > 0) || (totAmplitudeC > 0)) {
      registry.get<TH2>(HIST("collHadronic/FV0T0CCorrHadronic"))->Fill(totAmplitudeC, totalAmplitudefv0);
    }

    // Correlation FDD vs FT0
    if ((totAmpFddA > 0) || (totAmplitudeA > 0)) {
      registry.get<TH2>(HIST("collHadronic/FT0DDACorrHadronic"))->Fill(totAmplitudeA, totAmpFddA);
    }
    if ((totAmpFddC > 0) || (totAmplitudeC > 0)) {
      registry.get<TH2>(HIST("collHadronic/FT0DDCCorrHadronic"))->Fill(totAmplitudeC, totAmpFddC);
    }
    if ((totAmpFddC > 0) || (totAmplitudeA > 0)) {
      registry.get<TH2>(HIST("collHadronic/FT0CFDDAHadronic"))->Fill(totAmplitudeC, totAmpFddA);
    }
    if ((totAmpFddA > 0) || (totAmplitudeC > 0)) {
      registry.get<TH2>(HIST("collHadronic/FT0AFDDCHadronic"))->Fill(totAmplitudeA, totAmpFddC);
    }

    // Correlation FDD vs FV0
    if ((totAmpFddA > 0) || (totalAmplitudefv0 > 0)) {
      registry.get<TH2>(HIST("collHadronic/FV0AFDDAHadronic"))->Fill(totalAmplitudefv0, totAmpFddA);
    }
    if ((totAmpFddC > 0) || (totalAmplitudefv0 > 0)) {
      registry.get<TH2>(HIST("collHadronic/FV0AFDDCHadronic"))->Fill(totalAmplitudefv0, totAmpFddC);
    }
  ...
  void processInclusiveA(CC const& collision, BCs const& bct0s, TCs const& tracks, aod::FT0s const& ft0s, aod::FV0As const& fv0as, aod::FDDs const& fdds, aod::Zdcs& zdcs, aod::V0s const& v0s)
  {
    ...
    if (totAmplitudeC == 0) {
      registry.get<TH1>(HIST("colInclusive/FT0Aamp"))->Fill(totAmplitudeA);
    }
    if (totAmplitudeA == 0) {
      registry.get<TH1>(HIST("colInclusive/FT0Camp"))->Fill(totAmplitudeC);
    }
    if ((totAmplitudeA < 5) && ((totAmplitudeC > 5)))
      registry.get<TH2>(HIST("colInclusive/FT0ACCorr"))->Fill(totAmplitudeA, totAmplitudeC);
    ...
    if ((totalAmplitudefv0 == 0) && (nPVcont < 100)) {
      registry.get<TH1>(HIST("colInclusive/FV0Amp"))->Fill(nPVcont);
    }
    ...
    if (totAmpFddA == 0) {
      registry.get<TH1>(HIST("colInclusive/FDDAamp"))->Fill(totAmpFddC);
    }
    if (totAmpFddC == 0) {
      registry.get<TH1>(HIST("colInclusive/FDDCamp"))->Fill(totAmpFddA);
    }
    if (totAmpFddA < 5 && totAmpFddC > 5) {
      registry.get<TH2>(HIST("colInclusive/FDDACCorr"))->Fill(totAmpFddA, totAmpFddC);
    }

    if ((totAmplitudeA == 0) && (totAmpFddA == 0)) {
      registry.get<TH1>(HIST("colInclusive/FT0DDAPVtrk"))->Fill(nPVcont);
    }
    if ((totAmplitudeA == 0) && (totAmpFddA == 0)) {
      registry.get<TH1>(HIST("colInclusive/FT0DDAtrk"))->Fill(ntrks);
    }
    if ((totAmplitudeA == 0) && (totAmpFddA == 0)) {
      registry.get<TH2>(HIST("colInclusive/FT0DDCCorr"))->Fill(totAmplitudeC, totAmpFddC);
    }

    if ((totalAmplitudefv0 < 5) && (totAmpFddA == 0)) {
      registry.get<TH2>(HIST("colInclusive/FV0AFDDC"))->Fill(totalAmplitudefv0, totAmpFddC);
    }

    if (collision.has_foundFT0() && collision.has_foundFDD() && collision.has_foundFV0()) {
      if ((totAmplitudeA == 0) && (totAmpFddA == 0) && (totalAmplitudefv0 == 0)) {
        registry.get<TH1>(HIST("colInclusive/PVCFT0"))->Fill(nPVcont);
      }
      if ((totAmplitudeA == 0) && (totAmpFddA == 0) && (totalAmplitudefv0 == 0)) {
        registry.get<TH1>(HIST("colInclusive/GlobalBC"))->Fill(bcnum, 1.);
      }
    }
  }
  ...
  void processInclusiveC(CC const& collision, BCs const& bct0s, TCs const& tracks, aod::FT0s const& ft0s, aod::FV0As const& fv0as, aod::FDDs const& fdds, aod::Zdcs& zdcs, aod::V0s const& v0s)
  {
    ...
    if (totAmplitudeC == 0) {
      registry.get<TH1>(HIST("colInclusiveC/vtxTracks"))->Fill(collision.numContrib());
    }
    if (totAmplitudeC == 0) {
    ...
    if ((totAmplitudeA > 5) && ((totAmplitudeC < 5)))
      registry.get<TH2>(HIST("colInclusiveC/FT0ACCorr"))->Fill(totAmplitudeA, totAmplitudeC);
    ...
    if ((totAmplitudeC == 0) && (nPVcont < 100)) {
      registry.get<TH1>(HIST("colInclusiveC/FV0Amp"))->Fill(nPVcont);
    }
    ...
    if (totAmpFddC == 0) {
      registry.get<TH1>(HIST("colInclusiveC/FDDAamp"))->Fill(nPVcont);
    }
    if (totAmpFddC == 0) {
      registry.get<TH1>(HIST("colInclusiveC/FDDCamp"))->Fill(ntrks);
    }
    if (totAmpFddA > 5 && totAmpFddC < 5) {
      registry.get<TH2>(HIST("colInclusiveC/FDDACCorr"))->Fill(totAmpFddA, totAmpFddC);
    }

    if ((totAmplitudeC == 0) && (totAmpFddC == 0)) {
      registry.get<TH1>(HIST("colInclusiveC/FT0DDAPVtrk"))->Fill(nPVcont);
    }
    if ((totAmplitudeC == 0) && (totAmpFddC == 0)) {
      registry.get<TH1>(HIST("colInclusiveC/FT0DDAtrk"))->Fill(ntrks);
    }
    if ((totAmplitudeC == 0) && (totAmpFddC == 0)) {
      registry.get<TH2>(HIST("colInclusiveC/FT0DDCCorr"))->Fill(totAmplitudeA, totAmpFddA);
    }

    if ((totalAmplitudefv0 > 5) && (totAmpFddC == 0)) {
      registry.get<TH2>(HIST("colInclusiveC/FV0AFDDC"))->Fill(totalAmplitudefv0, totAmpFddA);
    }

    if (collision.has_foundFT0() && collision.has_foundFDD() && collision.has_foundFV0()) {
      if ((totAmplitudeC == 0) && (totAmpFddC == 0) && (totalAmplitudefv0 > 5)) {
        registry.get<TH1>(HIST("colInclusiveC/PVCFT0"))->Fill(nPVcont);
      }
      if ((totAmplitudeC == 0) && (totAmpFddC == 0) && (totalAmplitudefv0 > 5)) {
        registry.get<TH1>(HIST("colInclusiveC/GlobalBC"))->Fill(bcnum, 1.);
      }
    }
  }
