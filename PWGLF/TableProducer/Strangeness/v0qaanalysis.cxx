...
struct LfMyV0s {
  ...
  void init(InitContext const&)
  {
    ...
    registry.add("V0PosDauTracksEta", "V0PosDauTracksEta", {HistType::kTH1F, {{100, -1.0f, 1.0f}}});
    registry.add("V0NegDauTracksEta", "V0NegDauTracksEta", {HistType::kTH1F, {{100, -1.0f, 1.0f}}});
  ...
  void process(aod::MyV0Candidates const& myv0s)
  {
    for (auto& candidate : myv0s) {
      ...
      registry.fill(HIST("V0PosDauTracksEta"), candidate.v0poseta());
      registry.fill(HIST("V0NegDauTracksEta"), candidate.v0negeta());
    }
  }
};
